                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select name="is_active" id="is_active" class="form-input rounded-md shadow-sm mt-1 block w-full">
                              <option value="{{ $account->is_active }}" selected>{{ $account->is_active == 1 ? 'Active' : 'Deactive' }} (Current)</option>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="name_holder" id="name_holder" type="text"
                                class="form-input rounded-md shadow-sm mt-1 block w-full"
                                value="{{ old('name_holder', $account->name_holder) }}" />
                            @error('name_holder')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="bank_type" id="bank_type" type="text"
                                class="form-input rounded-md shadow-sm mt-1 block w-full"
                                value="{{ old('bank_type', $account->bank_type) }}" />
                            @error('bank_type')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="corporate_id" id="corporate_id" type="text"
                                class="form-input rounded-md shadow-sm mt-1 block w-full"
                                value="{{ old('corporate_id', $account->corporate_id) }}" />
                            @error('corporate_id')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
